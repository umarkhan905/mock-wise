...
interface Props {
  ...
  setFilters: React.Dispatch<React.SetStateAction<RecruiterFilters>>;
}
        ...
        <SheetContent>
          ...
          <section className="space-y-4 px-4">
            ...
            <Select
              ...
              onValueChange={(value) => handleFilterChange(value, "assessment")}
            >
              <SelectTrigger className="min-h-10 w-full">
            ...
            {showResetButton && (
              <Button
                ...
                onClick={() => setFilters(defaultRecruiterFilters)}
                type="button"
              >
